...
namespace SystemTrayLauncher.HookManager
{
    ...
    public static partial class HookManager
    {
        ...
        private static event KeyEventHandler s_KeyUp = KeyUp_Internal;
        ...
        private static event KeyEventHandler s_KeyDown = KeyDown_Internal;
        ...
        private static void KeyDown_Internal(object sender, KeyEventArgs e)
        {
        ...
        private static void KeyUp_Internal(object sender, KeyEventArgs e)
        {
            if (IsControlKey(e.KeyCode))
            {
                IsCtrlDown = false;
